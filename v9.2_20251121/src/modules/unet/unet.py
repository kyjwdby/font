...
class UNet(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        down_block_additional_residuals: torch.Tensor,
        ...
        for index, downsample_block in enumerate(self.down_blocks):
            ...
            #####
            # print(f"[{index}] shape = {tuple(sample.shape)}")
            if down_block_additional_residuals is not None:
                sample = sample + down_block_additional_residuals[index]
            #####
        ...
        if self.mid_block is not None:
            ...
            #####
            # print(f"mid shape = {tuple(sample.shape)}")
